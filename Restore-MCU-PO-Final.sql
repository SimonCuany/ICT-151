...
-- Generated: 2019-11-16 15:59
-- Model: New Model
-- Version: 1.0
-- Project: Script servant à restaurer la base de donnée fictive mcu (marvel), elle supprime l'ancienne base de donnée, crée la structure de la nouvelle, et ajoute les données.
-- Author: PC_Samuel_01/ Benoit Pierrehumbert
